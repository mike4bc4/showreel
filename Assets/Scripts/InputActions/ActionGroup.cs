...
//     version 1.6.3
//     from Assets/InputSystem/ActionGroup.inputactions
//
...
{
    public partial class @ActionGroup: IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": []
        ...
        {
            private @ActionGroup m_Wrapper;
            public UIActions(@ActionGroup wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @ActionGroup m_Wrapper;
            public InitialBoardActions(@ActionGroup wrapper) { m_Wrapper = wrapper; }
