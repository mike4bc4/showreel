...
namespace UI
{
    public partial class LayerManager2 : MonoBehaviour
    {
        ...
        public static Layer2 CreateLayer(VisualTreeAsset vta = null, string name = "Layer", int displaySortOrder = 0)
        {
            ...
            var layer = gameObject.AddComponent<Layer2>();
            layer.name = name;
            layer.displaySortOrder = displaySortOrder;
            layer.onDisplaySortOrderChanged += RebuildCommandBuffer;
